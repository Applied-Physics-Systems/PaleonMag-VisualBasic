...
Begin VB.Form frmOptions 
   ...
   Begin VB.Frame frameOptions 
      ...
      Top             =   600
      Width           =   6492
      Begin VB.TextBox txtCOMPortSettings_ApsIRM 
         Height          =   288
         Left            =   2040
         TabIndex        =   101
         Top             =   3720
         Width           =   2295
      End
      Begin VB.TextBox txtCOMPortApsIrm 
         Height          =   288
         Left            =   2040
         TabIndex        =   99
         Top             =   3240
   ...
   Begin VB.Frame frameOptions 
      ...
      Begin VB.Frame Frame1 
         Caption         =   "SQUID Jumps during Holder Measurements"
         Height          =   1215
         Left            =   0
         TabIndex        =   92
         Top             =   3720
         Width           =   6495
         Begin VB.CheckBox chkEnableHolderMomentRemeasureSetting 
            Caption         =   "Enable Setting"
            Height          =   495
            Left            =   4920
            TabIndex        =   98
            Top             =   240
            Width           =   1335
         End
         Begin VB.TextBox txtNumAllowedRemeasurements_IfHolderMomentTooHigh 
            Height          =   285
            Left            =   3480
            TabIndex        =   97
            Top             =   840
            Width           =   512
         End
         Begin VB.TextBox txtHolderMomentRemeasureThreshold 
            Height          =   285
            Left            =   3480
            TabIndex        =   93
            Top             =   360
         ...
         Begin VB.Label Label39 
            Caption         =   "# Times to Remeasure (0 = no email):"
            Height          =   255
            Left            =   720
            TabIndex        =   96
            Top             =   840
         ...
         Begin VB.Label Label35 
            Caption         =   "Remeasure Sample Holder if Holder Moment >"
            Height          =   375
            Left            =   120
            TabIndex        =   94
            Top             =   360
...
'-------------------------------------------------------------------------------------------------------'
    ...
    COMPortApsIrm = Int(txtCOMPortApsIrm.text)
    ...
    HolderMomentTooHighThreshold = val(txtHolderMomentRemeasureThreshold.text)
    HolderMomentTooHigh_NumAllowedRemeasures = val(txtNumAllowedRemeasurements_IfHolderMomentTooHigh.text)
    EnableHolderMomentTooHighRemeasurements = _
        (chkEnableHolderMomentRemeasureSetting.value = vbChecked)
...
carryforth:
    ...
    Me.txtCOMPortApsIrm = modConfig.COMPortApsIrm
    Me.txtCOMPortSettings_ApsIRM = modConfig.COMPortApsIrmSettings
    ...
    txtHolderMomentRemeasureThreshold.text = str$(HolderMomentTooHighThreshold)
    txtNumAllowedRemeasurements_IfHolderMomentTooHigh.text = str$(HolderMomentTooHigh_NumAllowedRemeasures)
    chkEnableHolderMomentRemeasureSetting.value = IIf(EnableHolderMomentTooHighRemeasurements, _
                                                      vbChecked, _
                                                      vbUnchecked)
