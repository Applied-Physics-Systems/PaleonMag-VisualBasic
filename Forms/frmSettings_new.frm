...
Begin VB.Form frmSettings 
   ...
   Begin VB.Frame frameOptions 
      ...
      Top             =   480
      Width           =   12615
      Begin VB.CheckBox chkOverrideHomeToTop_ForMoveMotorAbsoluteXY 
         Caption         =   "Override Home To Top For Small XY movements"
         Height          =   375
         Left            =   1800
         TabIndex        =   358
         Top             =   3360
   ...
   Begin VB.Frame frameOptions 
      ...
      Top             =   480
      Width           =   10215
      Begin VB.Frame groupBoxApsIRM 
         Caption         =   "APS IRM Settings"
         Height          =   1095
         Left            =   0
         TabIndex        =   359
         Top             =   480
         Width           =   3255
         Begin VB.CheckBox chkApsIrmEnableRangeChange 
            Caption         =   "Enable Range Change"
            Height          =   255
            Left            =   600
            TabIndex        =   362
            Top             =   720
            Width           =   1935
         End
         Begin VB.TextBox txtApsIrmRangeChangeThreshold 
            Height          =   288
            Left            =   2040
            TabIndex        =   361
            Top             =   360
         ...
         Begin VB.Label Label12 
            Caption         =   "Range Change Threshold:"
            Height          =   255
            Left            =   120
            TabIndex        =   360
            Top             =   360
      ...
      Begin VB.Frame frameAscIRMOutputVoltageBoostFactors 
         ...
         End
      End
      Begin VB.Frame groupBoxTrimOnTrue 
      ...
      Begin VB.ComboBox cmbIRMSystem 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmSettings_new.frx":0000
         Left            =   1920
         List            =   "frmSettings_new.frx":0002
         TabIndex        =   69
         Top             =   120
         Width           =   1935
      End
   ...
   Begin VB.Frame frameOptions 
      ...
      Top             =   600
      Width           =   9975
      Begin VB.OptionButton optAFRelay_AFConnectedPosition 
         Caption         =   "Down"
         Height          =   255
         Index           =   1
         Left            =   360
      ...
      End
      Begin VB.Label lblSettings 
         Caption         =   "AF Relay Position to Connect Coils to AF LC Circuit:"
         Height          =   495
         Index           =   91
         Left            =   0
         TabIndex        =   357
   ...
   Begin VB.Frame frameOptions 
      ...
      Top             =   600
      Width           =   10095
      Begin VB.OptionButton optDCMotorsHomeToTop_StopCondition 
         Caption         =   "False"
         Height          =   255
         Index           =   1
         Left            =   6480
      ...
      End
      Begin VB.Label lblSettings 
         Caption         =   "Stop Condition for Home To Top Stop if Input From Sensor is:"
         Height          =   375
         Index           =   90
         Left            =   6360
         TabIndex        =   354
...
Private Sub applySettings()
    ...
    DCMotorHomeToTop_StopOnTrue = (optDCMotorsHomeToTop_StopCondition(0).value)
    ...
    Me.chkOverrideHomeToTop_ForMoveMotorAbsoluteXY.value = Unchecked
    ...
    ElseIf cmbIRMSystem.ListIndex = 2 Then
        ...
        modConfig.IRMSystem = "APS"
        
    ElseIf cmbIRMSystem.ListIndex = 3 Then
    ...
    modConfig.ApsIrm_RangeChangeLevel = val(Me.txtApsIrmRangeChangeThreshold.text)
    modConfig.ApsIrm_DoRangeChange = (vbChecked = Me.chkApsIrmEnableRangeChange.value)
...
'----------------------------------------------------------------------------------------'
    ...
    'Set if AF's are connected to the "Up" terminal of the AF/IRM relay switches
    'or the "Down" terminal
    AFRelays_UseUpPosition = (optAFRelay_AFConnectedPosition(0).value)
...
Private Sub cmbIRMSystem_Click()
    ...
    If Me.cmbIRMSystem.ListIndex = 3 Then
    ...
    If Me.cmbIRMSystem.ListIndex = 2 Then
        ...
        EnableApsIRMControls
    
    Else
    
        DisableApsIRMControls
...
Public Sub Form_Load()
    ...
    cmbIRMSystem.AddItem "APS", 2
    cmbIRMSystem.AddItem "ASC", 3
...
'                  "Paleomag.ini file."
    ...
    'Now set the XY stage changer speed in the DC Motors(XY) tab
    Me.MoveSpeed = modConfig.ChangerSpeed
    
    'Now Set the Counts in the DC Motors(XY) tab
    Me.MoveCounts = Int(modConfig.OneStep / 10)
...
Private Sub importSettings()
    ...
    If modConfig.DCMotorHomeToTop_StopOnTrue Then
        ...
        Me.optDCMotorsHomeToTop_StopCondition(0).value = True
            
    Else
    
        Me.optDCMotorsHomeToTop_StopCondition(1).value = True
    ...
    Me.txtApsIrmRangeChangeThreshold.text = str$(modConfig.ApsIrm_RangeChangeLevel)
    Me.chkApsIrmEnableRangeChange.value = IIf(modConfig.ApsIrm_DoRangeChange, vbChecked, vbUnchecked)
...
'------------------------------------------------------------------------------------------------'
    ...
    'Set radio buttons for which AF Relay position connects the coils to the
    'AF LC Circuit ("Up" or "Down")
    If AFRelays_UseUpPosition Then
    
        optAFRelay_AFConnectedPosition(0).value = True
        
    Else
    
        optAFRelay_AFConnectedPosition(1).value = True
...
XYHolePositionsFlexGrid.Col = 0
Dim selected_hole As Long

If (XYHolePositionsFlexGrid.text = "HOME") Then
    selected_hole = 0
Else
    selected_hole = val(XYHolePositionsFlexGrid.text)
End If

modListenAndLog.AppendRS232MessageToLogFile _
    "Move to cup: " & XYHolePositionsFlexGrid.text & ", interpreted as cup: " & _
        str(selected_hole), _
    0, _
    ""
...
If (Not IsNumeric(Me.HomeHoleLocationBox.text)) Then Me.HomeHoleLocationBox.text = 0

If (selected_hole = 0 Or selected_hole = val(Me.HomeHoleLocationBox.text)) Then
    
    frmDCMotors.HomeToCenter_NoLoadCorner True
...
modListenAndLog.AppendRS232MessageToLogFile _
    "Move to (X, Y): (" & str(xpos) & ", " & str(ypos) & ")", _
    0, _
    ""
    ...
    frmDCMotors.MoveMotorAbsoluteXY MotorChangerY, ypos, val(LTrim$(MoveSpeed.text)), True, False
...
Public Sub SetAFSystem _
    ...
    Me.lblSettings(95).Visible = (cmbAFSystem = "2G")
    Me.lblSettings(96).Visible = (cmbAFSystem = "2G")
...
Private Sub EnableApsIRMControls()

    Me.groupBoxApsIRM.Visible = True
    Me.txtAxialMaxCapVoltage.Enabled = False
    Me.txtTransMaxCapVoltage.Enabled = False
    Me.lblAxialMaxCapVoltage.Enabled = False
    Me.lblTransMaxCapVoltage.Enabled = False
    Me.groupBoxTrimOnTrue.Enabled = False
    Me.optTrimOnFalse.Enabled = False
    Me.optTrimOnTrue.Enabled = False
End Sub

Private Sub DisableApsIRMControls()
    Me.groupBoxApsIRM.Visible = False
    Me.txtAxialMaxCapVoltage.Enabled = True
    Me.txtTransMaxCapVoltage.Enabled = True
    Me.lblAxialMaxCapVoltage.Enabled = True
    Me.lblTransMaxCapVoltage.Enabled = True
    Me.groupBoxTrimOnTrue.Enabled = True
    Me.optTrimOnFalse.Enabled = True
    Me.optTrimOnTrue.Enabled = True
End Sub
