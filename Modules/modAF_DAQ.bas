...
Public AF_Axial_Error_Status As af_ramp_error
Public AF_Transverse_Error_Status As af_ramp_error

Public AF_Error_Response_Table As AF_Error_Resp_Collection
...
Public Sub UpdateAFErrorStatus(ByRef af_error As af_ramp_error)

    If af_error Is Nothing Then Exit Sub
    
    Select Case af_error.CoilType
    
        Case coil_type.Axial
        
            Set modAF_DAQ.AF_Axial_Error_Status = af_error
        
        Case coil_type.Transverse
        
            Set modAF_DAQ.AF_Transverse_Error_Status = af_error
...
Public Sub ClearAFErrorStatus()

    Dim no_error As af_ramp_error
    Set no_error = New af_ramp_error
    
    Set modAF_DAQ.AF_Axial_Error_Status = no_error
    Set modAF_DAQ.AF_Transverse_Error_Status = no_error

End Sub

Public Sub InitDefault_AFErrorResponseTable()

    'Init or clear the current error response table
    If AF_Error_Response_Table Is Nothing Then
    
        Set AF_Error_Response_Table = New AF_Error_Resp_Collection
        
    Else
    
        AF_Error_Response_Table.Clear
        
    End If
    
    'AF CodeRed error responses
    'Express Code-Red Error
    AF_Error_Response_Table.Add FatalError, coil_type.Axial, CodeRed, ExpressError
    AF_Error_Response_Table.Add FatalError, coil_type.Transverse, CodeRed, ExpressError
    AF_Error_Response_Table.Add ZeroMonitorVoltage, coil_type.Axial, CodeRed, ExpressError
    AF_Error_Response_Table.Add ZeroMonitorVoltage, coil_type.Transverse, CodeRed, ExpressError
    AF_Error_Response_Table.Add TargetUndershoot, coil_type.Axial, CodeRed, ExpressError
    AF_Error_Response_Table.Add TargetUndershoot, coil_type.Transverse, CodeRed, ExpressError
    
    'Suppress Code-Red Error
    AF_Error_Response_Table.Add TargetOvershoot, coil_type.Axial, CodeRed, SuppressError
    AF_Error_Response_Table.Add TargetOvershoot, coil_type.Transverse, CodeRed, SuppressError
    
    
    'AF CodeYellow error responses
    'Express Code-Yellow Error
    AF_Error_Response_Table.Add FatalError, coil_type.Axial, CodeYellow, ExpressError
    AF_Error_Response_Table.Add FatalError, coil_type.Transverse, CodeYellow, ExpressError
    AF_Error_Response_Table.Add ZeroMonitorVoltage, coil_type.Axial, CodeYellow, ExpressError
    AF_Error_Response_Table.Add ZeroMonitorVoltage, coil_type.Transverse, CodeYellow, ExpressError
    AF_Error_Response_Table.Add TargetUndershoot, coil_type.Axial, CodeYellow, ExpressError
    AF_Error_Response_Table.Add TargetUndershoot, coil_type.Transverse, CodeYellow, ExpressError
    
    'Supress Code-Yellow Error
    AF_Error_Response_Table.Add TargetOvershoot, coil_type.Axial, CodeYellow, SuppressError
    AF_Error_Response_Table.Add TargetOvershoot, coil_type.Transverse, CodeYellow, SuppressError
